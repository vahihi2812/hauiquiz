...
public class ViewNoteList extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    private Button btn_add, btn_edit, btn_del;
    ...
    private void getWidget() {
        ...
        btn_add = findViewById(R.id.view_note_list_btn_add);
        btn_edit = findViewById(R.id.view_note_list_btn_edit);
        btn_del = findViewById(R.id.view_note_list_btn_del);
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.view_note_list_btn_add) {
            addNote(note);
        } else if (id == R.id.view_note_list_btn_edit) {
            editNote(note);
        } else if (id == R.id.view_note_list_btn_del) {
            delNote();
        }
    }
